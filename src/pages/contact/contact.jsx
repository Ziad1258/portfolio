  ...
  return (
    <div className="container mx-auto px-4 sm:px-12 py-24 bg-white  dark:bg-dark">
      <div className="head">
        <h1
          data-aos="zoom-in"
          className="font-bold text-3xl md:text-5xl text-center    dark:text-gray-300"
        >
          Contact Me
        </h1>
        <p
          data-aos="zoom-in"
          data-aos-delay="100"
          className="leading-loose text-center mt-5  text-gray-500 dark:text-gray-300 "
        >
      ...
      <form
        ...
        className="flex flex-col  lg:flex-row-reverse  mt-24"
      >
        <Lottie
          data-aos="zoom-in"
          data-aos-delay="200"
