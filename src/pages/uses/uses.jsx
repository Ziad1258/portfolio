    ...
    <div className="container mx-auto sm:px-12 px-4 py-24 flex flex-col gap-16 bg-white dark:bg-dark ">
      ...
      <div className="flex flex-col gap-16">
        {["workStationData","devTools","productivity"].map((item , index) => {
           ...
           return (
                <div style={{borderBottomWidth : index !== 2 ? "1px" : ""}}  key={index} className="flex flex-col md:flex-row gap-8 pb-8  border-gray-300 dark:border-gray-500">
                    <h1 className="font-bold capitalize dark:text-white text-xl w-[300px] "> {usesSection[0]} </h1>
                  ...
                  {usesSection[1].map((section , index) => {
                    return (
                        ...
                        <p className="text-gray-500 dark:gray-300 leading-loose ">{section.desc}</p>
                        </div>
                    )
                  })}
                  </div>
